...
Freee.prototype.post = function(url, json, fn) {
  this.call({
    method: 'POST',
    url: url,
    body: json
...
Freee.prototype.me = function(fn) {
  console.log('Freee.prototype.me')
...
Freee.prototype.postDeal = function(body, fn) {
  this.post('/api/1/deals.json', body, createCallback(fn));
};
